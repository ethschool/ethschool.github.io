...
then
  git clone -b master git@github.com:ethschool/ethschool.github.io.git .build
else
  git clone -b master https://$GITHUB_USER:$GITHUB_PERSONAL_ACCESS_TOKEN@github.com/ethschool/ethschool.github.io.git .build
fi
